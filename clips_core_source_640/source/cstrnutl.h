...
struct constraintRecord *CL_CopyConstraintRecord (Environment *,
						  CONSTRAINT_RECORD *);
...
CONSTRAINT_RECORD *CL_ExpressionToConstraintRecord (Environment *,
						    struct expr *);
CONSTRAINT_RECORD *CL_ArgumentTypeToConstraintRecord (Environment *,
						      unsigned);
