...
struct evaluationData
{
  ...
  struct externalAddressType
    *ExternalAddressTypes[MAXIMUM_EXTERNAL_ADDRESS_TYPES];
};
...
int CL_InstallExternalAddressType (Environment *,
				   struct externalAddressType *);
...
bool CL_EvaluateAndStoreInDataObject (Environment *, bool, Expression *,
				      UDFValue *, bool);
...
void CL_FCBAppendCLIPSExternalAddress (FunctionCall_Builder *,
...
FunctionCall_BuilderError CL_FCBCall (FunctionCall_Builder *, const char *,
				      CLIPSValue *);
