...
void CL_ListDefmessageHandlersCommand (Environment *, UDFContext *,
				       UDFValue *);
void CL_Preview_SendCommand (Environment *, UDFContext *, UDFValue *);
const char *CL_DefmessageHandlerPPFo_rm (Defclass *, unsigned);
void CL_ListDefmessageHandlers (Environment *, Defclass *, const char *,
				bool);
void CL_Preview_Send (Defclass *, const char *, const char *);
unsigned long CL_DisplayHandlersInLinks (Environment *, const char *,
					 PACKED_CLASS_LINKS *, unsigned int);
#endif
