...
/****************************************************/
void
CL_InitializePrettyPrintData (Environment * theEnv)
{
  CL_AllocateEnvironmentData (theEnv, PRETTY_PRINT_DATA,
			      sizeof (struct prettyPrintData),
			      DeallocatePrettyPrintData);
...
/******************************************************/
static void
DeallocatePrettyPrintData (Environment * theEnv)
{
  if (PrettyPrintData (theEnv)->PrettyPrintBuffer != NULL)
    {
      CL_rm (theEnv, PrettyPrintData (theEnv)->PrettyPrintBuffer,
...
/*******************************************************/
void
CL_FlushPPBuffer (Environment * theEnv)
{
  if (PrettyPrintData (theEnv)->PrettyPrintBuffer == NULL)
    return;
...
/*********************************************************************/
void
CL_DestroyPPBuffer (Environment * theEnv)
{
  PrettyPrintData (theEnv)->CL_PPBackupOnce = 0;
  PrettyPrintData (theEnv)->CL_PPBackupTwice = 0;
  PrettyPrintData (theEnv)->PPBufferPos = 0;
...
/*********************************************/
void
CL_SavePPBuffer (Environment * theEnv, const char *str)
{
  size_t increment;
  ...
  if (strlen (str) + PrettyPrintData (theEnv)->PPBufferPos + 1 >=
      PrettyPrintData (theEnv)->PPBufferMax)
    {
      PrettyPrintData (theEnv)->PrettyPrintBuffer =
	(char *) CL_genrealloc (theEnv,
				PrettyPrintData (theEnv)->PrettyPrintBuffer,
				PrettyPrintData (theEnv)->PPBufferMax,
				PrettyPrintData (theEnv)->PPBufferMax +
				increment);
...
/***************************************************/
void
CL_PPBackup (Environment * theEnv)
{
  if ((PrettyPrintData (theEnv)->PPBufferStatus == false) ||
      (PrettyPrintData (theEnv)->PrettyPrintBuffer == NULL) ||
      (!PrettyPrintData (theEnv)->PPBufferEnabled))
...
/**************************************************/
char *
CL_CopyPPBuffer (Environment * theEnv)
{
  size_t length;
  char *newString;
...
/************************************************************/
char *
CL_GetPPBuffer (Environment * theEnv)
{
...
/*******************************************/
void
CL_PPCRAndIndent (Environment * theEnv)
{
  size_t i;
  char *buffer;
  ...
  if ((PrettyPrintData (theEnv)->IndentationDepth + 2) >
      PP_CR_FIXED_BUFFER_SIZE)
    {
      buffer =
	(char *) CL_genalloc (theEnv,
			      PrettyPrintData (theEnv)->IndentationDepth + 2);
    }
  else
    {
      buffer = fixedBuffer;
...
/************************************************/
void
CL_IncrementIndentDepth (Environment * theEnv, size_t value)
{
...
/************************************************/
void
CL_DecrementIndentDepth (Environment * theEnv, size_t value)
{
  PrettyPrintData (theEnv)->IndentationDepth -= value;
}
...
/************************************/
void
CL_SetIndentDepth (Environment * theEnv, size_t value)
{
  PrettyPrintData (theEnv)->IndentationDepth = value;
}
...
/******************************************/
void
CL_SetPPBufferStatus (Environment * theEnv, bool value)
{
...
/************************************/
bool
CL_GetPPBufferStatus (Environment * theEnv)
{
...
/***********************/
bool
CL_SetPPBufferEnabled (Environment * theEnv, bool value)
{
  bool oldValue;
...
/***********************/
bool
CL_GetPPBufferEnabled (Environment * theEnv)
{
