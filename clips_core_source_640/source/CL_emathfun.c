...
/************************************************/
void
CL_ExtendedMathFunctionDefinitions (Environment * theEnv)
{
#if ! RUN_TIME
  CL_AddUDF (theEnv, "cos", "d", 1, 1, "ld", CL_CosFunction, "CL_CosFunction",
	     NULL);
  CL_AddUDF (theEnv, "sin", "d", 1, 1, "ld", CL_SinFunction, "CL_SinFunction",
	     NULL);
  CL_AddUDF (theEnv, "tan", "d", 1, 1, "ld", CL_TanFunction, "CL_TanFunction",
	     NULL);
  CL_AddUDF (theEnv, "sec", "d", 1, 1, "ld", CL_SecFunction, "CL_SecFunction",
	     NULL);
  CL_AddUDF (theEnv, "csc", "d", 1, 1, "ld", CL_CscFunction, "CL_CscFunction",
	     NULL);
  CL_AddUDF (theEnv, "cot", "d", 1, 1, "ld", CL_CotFunction, "CL_CotFunction",
	     NULL);
  CL_AddUDF (theEnv, "acos", "d", 1, 1, "ld", CL_AcosFunction,
	     "CL_AcosFunction", NULL);
  CL_AddUDF (theEnv, "asin", "d", 1, 1, "ld", CL_AsinFunction,
	     "CL_AsinFunction", NULL);
  CL_AddUDF (theEnv, "atan", "d", 1, 1, "ld", CL_AtanFunction,
	     "CL_AtanFunction", NULL);
  CL_AddUDF (theEnv, "asec", "d", 1, 1, "ld", CL_AsecFunction,
	     "CL_AsecFunction", NULL);
  CL_AddUDF (theEnv, "acsc", "d", 1, 1, "ld", CL_AcscFunction,
	     "CL_AcscFunction", NULL);
  CL_AddUDF (theEnv, "acot", "d", 1, 1, "ld", CL_AcotFunction,
	     "CL_AcotFunction", NULL);
  CL_AddUDF (theEnv, "cosh", "d", 1, 1, "ld", CL_CoshFunction,
	     "CL_CoshFunction", NULL);
  CL_AddUDF (theEnv, "sinh", "d", 1, 1, "ld", CL_SinhFunction,
	     "CL_SinhFunction", NULL);
  CL_AddUDF (theEnv, "tanh", "d", 1, 1, "ld", CL_TanhFunction,
	     "CL_TanhFunction", NULL);
  CL_AddUDF (theEnv, "sech", "d", 1, 1, "ld", CL_SechFunction,
	     "CL_SechFunction", NULL);
  CL_AddUDF (theEnv, "csch", "d", 1, 1, "ld", CL_CschFunction,
	     "CL_CschFunction", NULL);
  CL_AddUDF (theEnv, "coth", "d", 1, 1, "ld", CL_CothFunction,
	     "CL_CothFunction", NULL);
  CL_AddUDF (theEnv, "acosh", "d", 1, 1, "ld", CL_AcoshFunction,
	     "CL_AcoshFunction", NULL);
  CL_AddUDF (theEnv, "asinh", "d", 1, 1, "ld", CL_AsinhFunction,
	     "CL_AsinhFunction", NULL);
  CL_AddUDF (theEnv, "atanh", "d", 1, 1, "ld", CL_AtanhFunction,
	     "CL_AtanhFunction", NULL);
  CL_AddUDF (theEnv, "asech", "d", 1, 1, "ld", CL_AsechFunction,
	     "CL_AsechFunction", NULL);
  CL_AddUDF (theEnv, "acsch", "d", 1, 1, "ld", CL_AcschFunction,
	     "CL_AcschFunction", NULL);
  CL_AddUDF (theEnv, "acoth", "d", 1, 1, "ld", CL_AcothFunction,
	     "CL_AcothFunction", NULL);

  CL_AddUDF (theEnv, "mod", "ld", 2, 2, "ld", CL_ModFunction,
	     "CL_ModFunction", NULL);
  CL_AddUDF (theEnv, "exp", "d", 1, 1, "ld", CL_ExpFunction, "CL_ExpFunction",
	     NULL);
  CL_AddUDF (theEnv, "log", "d", 1, 1, "ld", CL_LogFunction, "CL_LogFunction",
	     NULL);
  CL_AddUDF (theEnv, "log10", "d", 1, 1, "ld", CL_Log10Function,
	     "CL_Log10Function", NULL);
  CL_AddUDF (theEnv, "sqrt", "d", 1, 1, "ld", CL_SqrtFunction,
	     "CL_SqrtFunction", NULL);
  CL_AddUDF (theEnv, "pi", "d", 0, 0, NULL, CL_PiFunction, "CL_PiFunction",
	     NULL);
  CL_AddUDF (theEnv, "deg-rad", "d", 1, 1, "ld", CL_DegRadFunction,
	     "CL_DegRadFunction", NULL);
  CL_AddUDF (theEnv, "rad-deg", "d", 1, 1, "ld", CL_RadDegFunction,
	     "CL_RadDegFunction", NULL);
  CL_AddUDF (theEnv, "deg-grad", "d", 1, 1, "ld", CL_DegGradFunction,
	     "CL_DegGradFunction", NULL);
  CL_AddUDF (theEnv, "grad-deg", "d", 1, 1, "ld", CL_GradDegFunction,
	     "CL_GradDegFunction", NULL);
  CL_AddUDF (theEnv, "**", "d", 2, 2, "ld", CL_PowFunction, "CL_PowFunction",
	     NULL);
  CL_AddUDF (theEnv, "round", "l", 1, 1, "ld", CL_RoundFunction,
	     "CL_RoundFunction", NULL);
#else
#if MAC_XCD
...
/************************************************************/
static bool
SingleNumberCheck (UDFContext * context, UDFValue * returnValue)
{
   /*======================================*/
...
/**************************************************************/
static bool
TestProximity (double theNumber, double range)
{
  if ((theNumber >= (-range)) && (theNumber <= range))
    return true;
  else
    return false;
}
...
/********************************************************/
static void
Do_mainErrorMessage (UDFContext * context, UDFValue * returnValue)
{
  Environment *theEnv = context->environment;

  CL_SetErrorValue (theEnv,
		    &CL_CreateSymbol (theEnv, "DOMAIN_ERROR")->header);
...
/************************************************************/
static void
ArgumentOverflowErrorMessage (UDFContext * context, UDFValue * returnValue)
{
  Environment *theEnv = context->environment;

  CL_SetErrorValue (theEnv,
		    &CL_CreateSymbol (theEnv, "ARGUMENT_OVERFLOW")->header);
...
/************************************************************/
static void
SingularityErrorMessage (UDFContext * context, UDFValue * returnValue)
{
  Environment *theEnv = context->environment;

  CL_SetErrorValue (theEnv,
		    &CL_CreateSymbol (theEnv,
				      "SINGULARITY_AT_ASYMPTOTE")->header);
...
/*************************************/
void
CL_CosFunction (Environment * theEnv,
		UDFContext * context, UDFValue * returnValue)
{
  ...
  returnValue->floatValue =
    CL_CreateFloat (theEnv, cos (CVCoerceToFloat (returnValue)));
}
...
/*************************************/
void
CL_SinFunction (Environment * theEnv,
		UDFContext * context, UDFValue * returnValue)
{
  if (!SingleNumberCheck (context, returnValue))
    {
  ...
  returnValue->floatValue =
    CL_CreateFloat (theEnv, sin (CVCoerceToFloat (returnValue)));
}
...
/*************************************/
void
CL_TanFunction (Environment * theEnv,
		UDFContext * context, UDFValue * returnValue)
{
  double tv;
  ...
  returnValue->floatValue =
    CL_CreateFloat (theEnv, sin (CVCoerceToFloat (returnValue)) / tv);
}
...
/*************************************/
void
CL_SecFunction (Environment * theEnv,
		UDFContext * context, UDFValue * returnValue)
{
  double tv;
...
/*************************************/
void
CL_CscFunction (Environment * theEnv,
		UDFContext * context, UDFValue * returnValue)
{
  double tv;
...
/*************************************/
void
CL_CotFunction (Environment * theEnv,
		UDFContext * context, UDFValue * returnValue)
{
  double tv;
  ...
  returnValue->floatValue =
    CL_CreateFloat (theEnv, cos (CVCoerceToFloat (returnValue)) / tv);
}
...
/**************************************/
void
CL_AcosFunction (Environment * theEnv,
		 UDFContext * context, UDFValue * returnValue)
{
  double num;
...
/**************************************/
void
CL_AsinFunction (Environment * theEnv,
		 UDFContext * context, UDFValue * returnValue)
{
  double num;
...
/**************************************/
void
CL_AtanFunction (Environment * theEnv,
		 UDFContext * context, UDFValue * returnValue)
{
  if (!SingleNumberCheck (context, returnValue))
    {
  ...
  returnValue->floatValue =
    CL_CreateFloat (theEnv, atan (CVCoerceToFloat (returnValue)));
}
...
/**************************************/
void
CL_AsecFunction (Environment * theEnv,
		 UDFContext * context, UDFValue * returnValue)
{
  double num;
...
/**************************************/
void
CL_AcscFunction (Environment * theEnv,
		 UDFContext * context, UDFValue * returnValue)
{
  double num;
...
/**************************************/
void
CL_AcotFunction (Environment * theEnv,
		 UDFContext * context, UDFValue * returnValue)
{
  double num;
...
/**************************************/
void
CL_CoshFunction (Environment * theEnv,
		 UDFContext * context, UDFValue * returnValue)
{
  if (!SingleNumberCheck (context, returnValue))
    {
  ...
  returnValue->floatValue =
    CL_CreateFloat (theEnv, cosh (CVCoerceToFloat (returnValue)));
}
...
/**************************************/
void
CL_SinhFunction (Environment * theEnv,
		 UDFContext * context, UDFValue * returnValue)
{
  if (!SingleNumberCheck (context, returnValue))
    {
  ...
  returnValue->floatValue =
    CL_CreateFloat (theEnv, sinh (CVCoerceToFloat (returnValue)));
}
...
/**************************************/
void
CL_TanhFunction (Environment * theEnv,
		 UDFContext * context, UDFValue * returnValue)
{
  if (!SingleNumberCheck (context, returnValue))
    {
  ...
  returnValue->floatValue =
    CL_CreateFloat (theEnv, tanh (CVCoerceToFloat (returnValue)));
}
...
/**************************************/
void
CL_SechFunction (Environment * theEnv,
		 UDFContext * context, UDFValue * returnValue)
{
  if (!SingleNumberCheck (context, returnValue))
    {
  ...
  returnValue->floatValue =
    CL_CreateFloat (theEnv, 1.0 / cosh (CVCoerceToFloat (returnValue)));
}
...
/**************************************/
void
CL_CschFunction (Environment * theEnv,
		 UDFContext * context, UDFValue * returnValue)
{
  double num;
...
/**************************************/
void
CL_CothFunction (Environment * theEnv,
		 UDFContext * context, UDFValue * returnValue)
{
  double num;
...
/***************************************/
void
CL_AcoshFunction (Environment * theEnv,
		  UDFContext * context, UDFValue * returnValue)
{
  double num;
...
/***************************************/
void
CL_AsinhFunction (Environment * theEnv,
		  UDFContext * context, UDFValue * returnValue)
{
  if (!SingleNumberCheck (context, returnValue))
    {
  ...
  returnValue->floatValue =
    CL_CreateFloat (theEnv, genasinh (CVCoerceToFloat (returnValue)));
}
...
/***************************************/
void
CL_AtanhFunction (Environment * theEnv,
		  UDFContext * context, UDFValue * returnValue)
{
  double num;
...
/***************************************/
void
CL_AsechFunction (Environment * theEnv,
		  UDFContext * context, UDFValue * returnValue)
{
  double num;
...
/***************************************/
void
CL_AcschFunction (Environment * theEnv,
		  UDFContext * context, UDFValue * returnValue)
{
  double num;
...
/***************************************/
void
CL_AcothFunction (Environment * theEnv,
		  UDFContext * context, UDFValue * returnValue)
{
  double num;
...
/*************************************/
void
CL_ExpFunction (Environment * theEnv,
		UDFContext * context, UDFValue * returnValue)
{
  if (!SingleNumberCheck (context, returnValue))
    {
  ...
  returnValue->floatValue =
    CL_CreateFloat (theEnv, exp (CVCoerceToFloat (returnValue)));
}
...
/*************************************/
void
CL_LogFunction (Environment * theEnv,
		UDFContext * context, UDFValue * returnValue)
{
  double num;
...
/***************************************/
void
CL_Log10Function (Environment * theEnv,
		  UDFContext * context, UDFValue * returnValue)
{
  double num;
...
/**************************************/
void
CL_SqrtFunction (Environment * theEnv,
		 UDFContext * context, UDFValue * returnValue)
{
  double num;
...
/*************************************/
void
CL_PowFunction (Environment * theEnv,
		UDFContext * context, UDFValue * returnValue)
{
...
/*************************************/
void
CL_ModFunction (Environment * theEnv,
		UDFContext * context, UDFValue * returnValue)
{
  ...
  if ((CVIsType (&item2, INTEGER_BIT) ? (item2.integerValue->contents == 0L) :
       false)
      || (CVIsType (&item2, FLOAT_BIT) ? (item2.floatValue->contents == 0.0) :
	  false))
    {
  ...
  if (CVIsType (&item1, FLOAT_BIT) || CVIsType (&item2, FLOAT_BIT))
    {
      ...
      returnValue->floatValue =
	CL_CreateFloat (theEnv, fnum1 - (dtrunc (fnum1 / fnum2) * fnum2));
    }
  else
    {
	...
	CL_CreateInteger (theEnv, lnum1 - (lnum1 / lnum2) * lnum2);
    }
}
...
/************************************/
void
CL_PiFunction (Environment * theEnv,
	       UDFContext * context, UDFValue * returnValue)
{
...
/****************************************/
void
CL_DegRadFunction (Environment * theEnv,
		   UDFContext * context, UDFValue * returnValue)
{
  if (!SingleNumberCheck (context, returnValue))
    {
  ...
  returnValue->floatValue =
    CL_CreateFloat (theEnv, CVCoerceToFloat (returnValue) * PI / 180.0);
}
...
/****************************************/
void
CL_RadDegFunction (Environment * theEnv,
		   UDFContext * context, UDFValue * returnValue)
{
  if (!SingleNumberCheck (context, returnValue))
    {
  ...
  returnValue->floatValue =
    CL_CreateFloat (theEnv, CVCoerceToFloat (returnValue) * 180.0 / PI);
}
...
/*****************************************/
void
CL_DegGradFunction (Environment * theEnv,
		    UDFContext * context, UDFValue * returnValue)
{
  if (!SingleNumberCheck (context, returnValue))
    {
  ...
  returnValue->floatValue =
    CL_CreateFloat (theEnv, CVCoerceToFloat (returnValue) / 0.9);
}
...
/*****************************************/
void
CL_GradDegFunction (Environment * theEnv,
		    UDFContext * context, UDFValue * returnValue)
{
  if (!SingleNumberCheck (context, returnValue))
    {
...
/***************************************/
void
CL_RoundFunction (Environment * theEnv,
		  UDFContext * context, UDFValue * returnValue)
{
   /*======================================*/
  /* Check that the argument is a number. */
