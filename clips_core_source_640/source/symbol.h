...
CLIPSExternalAddress *CL_CreateExternalAddress (Environment *, void *,
						unsigned short);
...
struct symbolMatch *CL_FindSymbol_Matches (Environment *, const char *,
					   unsigned *, size_t *);
void ReturnSymbol_Matches (Environment *, struct symbolMatch *);
CLIPSLexeme *CL_GetNextSymbolMatch (Environment *, const char *, size_t,
				    CLIPSLexeme *, bool, size_t *);
