...
/***************************************/
void
Print_FactJNCompVars1 (Environment * theEnv,
...
/***************************************/
void
Print_FactJNCompVars2 (Environment * theEnv,
		       const char *logicalName, void *theValue)
{
#if DEVELOPER
...
/***************************************/
void
Print_FactPNCompVars1 (Environment * theEnv,
		       const char *logicalName, void *theValue)
{
#if DEVELOPER
  ...
  if (hack->pass)
    ...
    CL_WriteString (theEnv, logicalName, "n ");
...
/**************************************/
void
Print_FactSlotLength (Environment * theEnv,
		      const char *logicalName, void *theValue)
{
#if DEVELOPER
...
/*************************************/
void
Print_FactJNGetVar1 (Environment * theEnv,
		     const char *logicalName, void *theValue)
{
#if DEVELOPER
  ...
  if (hack->factAddress)
    CL_WriteString (theEnv, logicalName, "t ");
  else
    CL_WriteString (theEnv, logicalName, "f ");
  if (hack->allFields)
    CL_WriteString (theEnv, logicalName, "t ");
...
/*************************************/
void
Print_FactJNGetVar2 (Environment * theEnv,
		     const char *logicalName, void *theValue)
{
#if DEVELOPER
...
/*************************************/
void
Print_FactJNGetVar3 (Environment * theEnv,
		     const char *logicalName, void *theValue)
{
#if DEVELOPER
...
/*************************************/
void
Print_FactPNGetVar1 (Environment * theEnv,
		     const char *logicalName, void *theValue)
{
#if DEVELOPER
  ...
  if (hack->factAddress)
    ...
    CL_WriteString (theEnv, logicalName, "f ");
  if (hack->allFields)
    CL_WriteString (theEnv, logicalName, "t F");
  else
    CL_WriteString (theEnv, logicalName, "f F");
...
/*************************************/
void
Print_FactPNGetVar2 (Environment * theEnv,
		     const char *logicalName, void *theValue)
{
#if DEVELOPER
...
/*************************************/
void
Print_FactPNGetVar3 (Environment * theEnv,
		     const char *logicalName, void *theValue)
{
#if DEVELOPER
  ...
  if (hack->fromBeginning)
    ...
    CL_WriteString (theEnv, logicalName, "f ");
  if (hack->fromEnd)
    CL_WriteString (theEnv, logicalName, "t B");
  else
    CL_WriteString (theEnv, logicalName, "f B");
...
/***************************************/
void
Print_FactPNConstant1 (Environment * theEnv,
		       const char *logicalName, void *theValue)
{
#if DEVELOPER
  ...
  CL_PrintAtom (theEnv, logicalName, GetFirstArgument ()->type,
		GetFirstArgument ()->value);
  CL_WriteString (theEnv, logicalName, ")");
#else
#if MAC_XCD
#pragma unused(theEnv)
...
/***************************************/
void
Print_FactPNConstant2 (Environment * theEnv,
		       const char *logicalName, void *theValue)
{
#if DEVELOPER
