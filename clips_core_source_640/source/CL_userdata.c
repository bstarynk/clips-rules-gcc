...
/*************************************************/
void
CL_InitializeUserDataData (Environment * theEnv)
{
  CL_AllocateEnvironmentData (theEnv, USER_DATA_DATA,
			      sizeof (struct userDataData), NULL);
}
...
/******************************************************/
unsigned char
CL_InstallUserDataRecord (Environment * theEnv,
...
/*****************************************************/
struct userData *
CL_FetchUserData (Environment * theEnv,
		  unsigned char userDataID, struct userData **theList)
{
  struct userData *theData;

  for (theData = *theList; theData != NULL; theData = theData->next)
    {
...
/*****************************************************/
struct userData *
CL_TestUserData (unsigned char userDataID, struct userData *theList)
{
  struct userData *theData;
...
/***************************************************************/
void
CL_ClearUserDataList (Environment * theEnv, struct userData *theList)
{
...
/*************************************************/
struct userData *
CL_DeleteUserData (Environment * theEnv,
		   unsigned char userDataID, struct userData *theList)
{
