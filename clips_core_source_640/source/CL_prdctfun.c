...
/**************************************************/
void
CL_PredicateFunctionDefinitions (Environment * theEnv)
{
#if ! RUN_TIME
  CL_AddUDF (theEnv, "not", "b", 1, 1, NULL, CL_NotFunction, "CL_NotFunction",
	     NULL);
  CL_AddUDF (theEnv, "and", "b", 2, UNBOUNDED, NULL, CL_AndFunction,
	     "CL_AndFunction", NULL);
  CL_AddUDF (theEnv, "or", "b", 2, UNBOUNDED, NULL, CL_OrFunction,
	     "CL_OrFunction", NULL);

  CL_AddUDF (theEnv, "eq", "b", 2, UNBOUNDED, NULL, CL_EqFunction,
	     "CL_EqFunction", NULL);
  CL_AddUDF (theEnv, "neq", "b", 2, UNBOUNDED, NULL, CL_NeqFunction,
	     "CL_NeqFunction", NULL);

  CL_AddUDF (theEnv, "<=", "b", 2, UNBOUNDED, "ld",
	     CL_LessThanOrEqualFunction, "CL_LessThanOrEqualFunction", NULL);
  CL_AddUDF (theEnv, ">=", "b", 2, UNBOUNDED, "ld",
	     CL_GreaterThanOrEqualFunction, "CL_GreaterThanOrEqualFunction",
	     NULL);
  CL_AddUDF (theEnv, "<", "b", 2, UNBOUNDED, "ld", CL_LessThanFunction,
	     "CL_LessThanFunction", NULL);
  CL_AddUDF (theEnv, ">", "b", 2, UNBOUNDED, "ld", CL_GreaterThanFunction,
	     "CL_GreaterThanFunction", NULL);
  CL_AddUDF (theEnv, "=", "b", 2, UNBOUNDED, "ld", CL_NumericEqualFunction,
	     "CL_NumericEqualFunction", NULL);
  CL_AddUDF (theEnv, "<>", "b", 2, UNBOUNDED, "ld",
	     CL_NumericNotEqualFunction, "CL_NumericNotEqualFunction", NULL);
  CL_AddUDF (theEnv, "!=", "b", 2, UNBOUNDED, "ld",
	     CL_NumericNotEqualFunction, "CL_NumericNotEqualFunction", NULL);

  CL_AddUDF (theEnv, "symbolp", "b", 1, 1, NULL, CL_SymbolpFunction,
	     "CL_SymbolpFunction", NULL);
  CL_AddUDF (theEnv, "stringp", "b", 1, 1, NULL, CL_StringpFunction,
	     "CL_StringpFunction", NULL);
  CL_AddUDF (theEnv, "lexemep", "b", 1, 1, NULL, CL_LexemepFunction,
	     "CL_LexemepFunction", NULL);
  CL_AddUDF (theEnv, "numberp", "b", 1, 1, NULL, CL_NumberpFunction,
	     "CL_NumberpFunction", NULL);
  CL_AddUDF (theEnv, "integerp", "b", 1, 1, NULL, CL_IntegerpFunction,
	     "CL_IntegerpFunction", NULL);
  CL_AddUDF (theEnv, "floatp", "b", 1, 1, NULL, CL_FloatpFunction,
	     "CL_FloatpFunction", NULL);
  CL_AddUDF (theEnv, "oddp", "b", 1, 1, "l", CL_OddpFunction,
	     "CL_OddpFunction", NULL);
  CL_AddUDF (theEnv, "evenp", "b", 1, 1, "l", CL_EvenpFunction,
	     "CL_EvenpFunction", NULL);
  CL_AddUDF (theEnv, "multifieldp", "b", 1, 1, NULL, CL_MultifieldpFunction,
	     "CL_MultifieldpFunction", NULL);
  CL_AddUDF (theEnv, "pointerp", "b", 1, 1, NULL, CL_ExternalAddresspFunction,
	     "CL_ExternalAddresspFunction", NULL);
  CL_AddUDF (theEnv, "external-addressp", "b", 1, 1, NULL,
	     CL_ExternalAddresspFunction, "CL_ExternalAddresspFunction",
	     NULL);
#else
#if MAC_XCD
...
/************************************/
void
CL_EqFunction (Environment * theEnv,
...
/*************************************/
void
CL_NeqFunction (Environment * theEnv,
		UDFContext * context, UDFValue * returnValue)
{
  UDFValue item, nextItem;
  unsigned int numArgs, i;
  ...
  for (i = 2, theExpression = GetNextArgument (theExpression);
       i <= numArgs; i++, theExpression = GetNextArgument (theExpression))
    {
      CL_EvaluateExpression (theEnv, theExpression, &nextItem);
      if (nextItem.header->type != item.header->type)
	{
...
/*****************************************/
void
CL_StringpFunction (Environment * theEnv,
		    UDFContext * context, UDFValue * returnValue)
{
  UDFValue item;
...
/*****************************************/
void
CL_SymbolpFunction (Environment * theEnv,
		    UDFContext * context, UDFValue * returnValue)
{
  UDFValue item;
...
/*****************************************/
void
CL_LexemepFunction (Environment * theEnv,
		    UDFContext * context, UDFValue * returnValue)
{
  UDFValue item;
...
/*****************************************/
void
CL_NumberpFunction (Environment * theEnv,
		    UDFContext * context, UDFValue * returnValue)
{
  UDFValue item;
...
/****************************************/
void
CL_FloatpFunction (Environment * theEnv,
		   UDFContext * context, UDFValue * returnValue)
{
  UDFValue item;
...
/******************************************/
void
CL_IntegerpFunction (Environment * theEnv,
		     UDFContext * context, UDFValue * returnValue)
{
  UDFValue item;
...
/*********************************************/
void
CL_MultifieldpFunction (Environment * theEnv,
			UDFContext * context, UDFValue * returnValue)
{
  UDFValue item;
...
/************************************************/
void
CL_ExternalAddresspFunction (Environment * theEnv,
			     UDFContext * context, UDFValue * returnValue)
{
  UDFValue item;
...
/***********************************/
void
CL_NotFunction (Environment * theEnv,
		UDFContext * context, UDFValue * returnValue)
{
  UDFValue theArg;
...
/*************************************/
void
CL_AndFunction (Environment * theEnv,
		UDFContext * context, UDFValue * returnValue)
{
  UDFValue theArg;
...
/************************************/
void
CL_OrFunction (Environment * theEnv,
	       UDFContext * context, UDFValue * returnValue)
{
  UDFValue theArg;
...
/*****************************************/
void
CL_LessThanOrEqualFunction (Environment * theEnv,
			    UDFContext * context, UDFValue * returnValue)
{
  UDFValue rv1, rv2;
...
/********************************************/
void
CL_GreaterThanOrEqualFunction (Environment * theEnv,
			       UDFContext * context, UDFValue * returnValue)
{
  UDFValue rv1, rv2;
...
/**********************************/
void
CL_LessThanFunction (Environment * theEnv,
		     UDFContext * context, UDFValue * returnValue)
{
  UDFValue rv1, rv2;
...
/*************************************/
void
CL_GreaterThanFunction (Environment * theEnv,
			UDFContext * context, UDFValue * returnValue)
{
  UDFValue rv1, rv2;
...
/**************************************/
void
CL_NumericEqualFunction (Environment * theEnv,
			 UDFContext * context, UDFValue * returnValue)
{
  UDFValue rv1, rv2;
...
/*****************************************/
void
CL_NumericNotEqualFunction (Environment * theEnv,
			    UDFContext * context, UDFValue * returnValue)
{
  UDFValue rv1, rv2;
...
/**************************************/
void
CL_OddpFunction (Environment * theEnv,
		 UDFContext * context, UDFValue * returnValue)
{
  UDFValue item;
...
/***************************************/
void
CL_EvenpFunction (Environment * theEnv,
		  UDFContext * context, UDFValue * returnValue)
{
  UDFValue item;
  long long num, halfnum;
