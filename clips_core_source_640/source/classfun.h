...
void CL_PrintPackedClassLinks (Environment *, const char *, const char *,
			       PACKED_CLASS_LINKS *);
#endif
...
void CL_AddClassLink (Environment *, PACKED_CLASS_LINKS *, Defclass *, bool,
		      unsigned int);
...
SLOT_NAME *CL_AddSlotName (Environment *, CLIPSLexeme *, unsigned short,
			   bool);
